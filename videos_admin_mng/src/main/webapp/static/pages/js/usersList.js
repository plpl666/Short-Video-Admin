...
var List = function () {
	...
	var handleList = function() {
        ...
        jqGrid.jqGrid({  
            caption: "短视频用户列表",  
            url: hdnContextPath + "/users/queryUserList",
            mtype: "post",  
            ...
            colModel: [  
                ...
                { name: 'faceImg', index: 'faceImg', width: 30, sortable: false,
        ...
        $("#searchUserListButton").click(function(){
        	...
        	jqGrid.jqGrid().setGridParam({ 
        		page: 1,
                url: hdnContextPath + "/users/queryUserList?" + searchUsersListForm.serialize()
            }).trigger("reloadGrid");
        });
    };
